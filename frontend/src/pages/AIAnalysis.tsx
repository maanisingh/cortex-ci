  ...
  const analysisTypes = [
    {
      ...
      description: "Detect unusual patterns in entity risk scores",
    },
    {
      value: "pattern",
    ...
    {
      value: "scenario",
      label: "Scenario Acceleration",
      icon: BeakerIcon,
      description: "Accelerate stress test simulations",
    },
    {
      value: "clustering",
      label: "Entity Clustering",
      icon: CpuChipIcon,
      description: "Group similar entities together",
    },
  ];
      ...
      <div className="sm:flex sm:items-center mb-6">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Controlled AI with human-in-the-loop approval for pattern detection
            and analysis
          </p>
        </div>
      ...
      <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <div className="flex">
          ...
          <div className="text-sm text-blue-800">
            <span className="font-semibold">Controlled AI:</span> All AI outputs
            require human approval before action. AI is limited to pattern
            detection, anomaly flagging, and report summarization.
          </div>
        </div>
      </div>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium ${statusColors[analysis.status]}`}
                      >
                        {analysis.status}
                      </span>
                      <span className="px-2 py-1 rounded text-xs font-medium bg-purple-100 text-purple-800">
                        {analysisTypes.find(
                          (t) => t.value === analysis.analysis_type,
                    ...
                    <div className="text-sm text-gray-500 mt-1 flex items-center gap-4">
                      ...
                      {analysis.confidence !== undefined && (
                        <span
                          className={`font-medium ${confidenceColor(analysis.confidence)}`}
                        >
              ...
              <div key={anomaly.id} className="card">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div
                      className={`text-sm mt-2 font-medium ${confidenceColor(anomaly.confidence)}`}
                    >
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="mt-3 text-xs text-gray-500">
                    <div>
                      <span className="font-medium">Model:</span> Isolation
                      Forest / K-Means
                    </div>
                    <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {
                      analysisTypes.find(
                        (t) => t.value === requestForm.analysis_type,
                      )?.description
                    }
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="font-medium">
                    {
                      analysisTypes.find(
                        (t) => t.value === selectedAnalysis.analysis_type,
                      )?.label
                    }
                  </div>
                </div>
                <div>
                  ...
                  <span
                    className={`px-2 py-1 rounded text-sm font-medium ${statusColors[selectedAnalysis.status]}`}
                  >
                ...
                {selectedAnalysis.confidence !== undefined && (
                  <div>
                    ...
                    <div
                      className={`font-medium ${confidenceColor(selectedAnalysis.confidence)}`}
                    >
