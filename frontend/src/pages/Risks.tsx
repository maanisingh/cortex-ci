...
export default function Risks() {
  ...
  const filteredEntities = (entities || [])
    .filter((e: EntityWithRisk) => {
      ...
      return (
        e.risk_score?.risk_level?.toLowerCase() === selectedLevel.toLowerCase()
      );
    })
    ...
    <div>
      <div className="sm:flex sm:items-center mb-6">
        ...
        <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
          ...
          >
            <ArrowPathIcon
              className={`h-5 w-5 mr-2 ${recalculateMutation.isPending ? "animate-spin" : ""}`}
            />
            ...
            style={{
              ...
              backgroundColor:
                (summary?.average_score || 0) >= 75
                  ? "#ef4444"
                  : (summary?.average_score || 0) >= 50
                    ? "#f97316"
                    : (summary?.average_score || 0) >= 25
                      ? "#eab308"
                      : "#22c55e",
            }}
          />
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {entitiesLoading ? (
                ...
                <tr>
                  ...
                  >
                    No entities found
                    {selectedLevel ? ` with ${selectedLevel} risk level` : ""}
                  </td>
                </tr>
              ) : (
                          ...
                          <div className="w-16 bg-gray-200 rounded-full h-2 mr-2">
                            <div
                              ...
                              style={{
                                ...
                                backgroundColor:
                                  riskBadgeColors[
                                    entity.risk_score.risk_level?.toLowerCase()
                                  ] || "#6b7280",
                              }}
                            />
                          </div>
                        ...
                        <div className="text-xs space-y-1">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {entity.risk_score.constraint_score?.toFixed(1) ||
                                "-"}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {entity.risk_score.dependency_score?.toFixed(1) ||
                                "-"}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {entity.risk_score.country_score?.toFixed(1) ||
                                "-"}
                            </span>
                          </div>
                        </div>
