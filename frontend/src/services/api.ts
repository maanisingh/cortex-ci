...
export const authApi = {
  login: (email: string, password: string, tenantSlug?: string, mfaCode?: string) =>
    api.post("/auth/login", { email, password, tenant_slug: tenantSlug, mfa_code: mfaCode }),
  ...
  mfa: {
    ...
    useBackupCode: (mfaToken: string, backupCode: string) =>
      api.post("/auth/mfa/backup-code", { mfa_token: mfaToken, backup_code: backupCode }),
...
export const entitiesApi = {
  ...
  bulkImport: (data: { entities: Record<string, unknown>[]; skip_duplicates?: boolean }) =>
...
export const constraintsApi = {
  ...
  update: (id: string, data: Record<string, unknown>) => api.put(`/constraints/${id}`, data),
...
export const dependenciesApi = {
  ...
  update: (id: string, data: Record<string, unknown>) => api.put(`/dependencies/${id}`, data),
...
export const scenariosApi = {
  ...
  update: (id: string, data: Record<string, unknown>) => api.put(`/scenarios/${id}`, data),
